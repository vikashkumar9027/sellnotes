...
export const MOCK_PURCHASES: Purchase[] = [
  {
    ...
    platform_fee_amount: 9.8,
    seller_gross_amount: 49,
    seller_net_amount: 39.2,
    amount: 49,
    platform_fee: 9.8,
    seller_amount: 39.2,
    status: 'paid',
  ...
  },
  {
    ...
    platform_fee_rate: 20,
    platform_fee_amount: 19.8,
    seller_gross_amount: 99,
    seller_net_amount: 79.2,
    amount: 99,
    platform_fee: 19.8,
    seller_amount: 79.2,
    status: 'paid',
...
export const DEFAULT_SYSTEM_SETTINGS: SystemSettings = {
  platform_commission: 20, // 20% PLATFORM FEE COMMISSION AS REQUESTED BY USER
  gst_rate: 18,
  min_note_price: 0,
  max_note_price: 2000,
