...
export async function GET(request: NextRequest) {
  try {
    ...
    if (sort === 'newest') {
      ...
      // Relevance: if search query, sort by downloads and rating
    ...
    // Sanitize seller and note structure
    ...
    // Also fetch distinct available subjects, universities, courses for sidebar filters
